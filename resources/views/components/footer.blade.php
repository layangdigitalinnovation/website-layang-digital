        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div class="lg:col-span-5">
                <a href="/" class="flex flex-col items-start group mb-6">
                    <img src="{{ asset('images/logo-layang1.png') }}" alt="Layang Digital Logo" class="h-10 md:h-12 w-auto object-contain mb-2 opacity-90 group-hover:opacity-100 transition-opacity">
                    <span class="text-[10px] uppercase tracking-widest text-primary-400 mt-1 font-medium">Innovation &bull; Software &bull; Digital Systems</span>
                </a>
                <p class="text-slate-400 text-sm leading-relaxed mb-8 max-w-sm">
                    Membantu bisnis membangun sistem digital yang lebih efisien, terintegrasi dan siap berkembang.
                </p>
                <div class="flex space-x-4">
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/layangdigital/" target="_blank" class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-primary-600 hover:text-white transition-colors">
                    ...
                    <!-- Facebook -->
                    <a href="https://www.facebook.com/Layangdigital/" target="_blank" class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-primary-600 hover:text-white transition-colors">
                        <span class="sr-only">Facebook</span>
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <!-- YouTube -->
                    <a href="https://www.youtube.com/@layangdigitalinnovation3011" target="_blank" class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-primary-600 hover:text-white transition-colors">
